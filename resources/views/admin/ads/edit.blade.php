...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                {!! Form::model($ads, array('method' => 'PUT','route' => ['ads.update', $ads->id],'files' => true)) !!}
                <div class="card-header bg-info">Atualizar publicidade</div>
                <div class="card-body">
    ...
    <script>
        ...
        function getStateAreas(plataform_id){
            ...
            $.get( ajax_url, function( data ) {
                $('#local_id').empty().append('<option value="">Selecione um local</option>');
