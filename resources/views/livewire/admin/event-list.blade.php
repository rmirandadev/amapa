        ...
        @forelse($events as $event)
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a href="{{ route('event.show',$event->id) }}" class="btn btn-warning btn-xs"><i class="fas fa-eye"></i></a>
                    <a href="{{ route('event.edit',$event->id) }}" class="btn btn-info btn-xs"><i class="fas fa-edit"></i></a>
                    {!! Form::model($event, ['method' => 'delete', 'route' => ['event.destroy', $event->id], 'class' =>'form-delete', 'style' => 'display:inline']) !!}
