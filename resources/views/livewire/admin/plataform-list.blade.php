        ...
        @forelse($plataforms as $plataform)
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a href="{{ route('plataform.edit',$plataform->id) }}" class="btn btn-info btn-xs"><i class="fas fa-edit"></i></a>
                    {!! Form::model($plataform, ['method' => 'delete', 'route' => ['plataform.destroy', $plataform->id], 'class' =>'form-delete', 'style' => 'display:inline']) !!}
                    <button type="submit" name="delete_modal" class="btn btn-danger btn-xs delete"><i class="fas fa-trash"></i></button>
                    {!! Form::close() !!}
                </td>
            </tr>
        @empty
