...
return [
    ...
    */
    ...
    'logo' => 'Gerente',
    'logo_img' => 'vendor/adminlte/dist/img/admin_icon.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Gerente',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active'    => ['ads*','local*','plataform*'],
            'role'     => ['Administrador','Editor'],
            'submenu' => [
                [
                    'text'      => 'Plataformas',
                    'route'     => 'plataform.index',
                    'icon'      => 'fas fa-fw fa-coins',
                    'active'    => ['plataform*'],
                    'role'     => ['Administrador','Editor'],
                ],
                [
                    'text'      => 'Locais de anúncios',
                    'route'     => 'local.index',
    ...
    */
    ...
    'filters' => [
        ...
        App\Filters\SpatieFilter::class
    ],
